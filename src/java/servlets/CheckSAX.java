...
public class CheckSAX extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Clients> clients = filterList(parser.readSaxXml(), text);
        try (PrintWriter out = response.getWriter()) {
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Clients table from XML by SAX</title> <meta charset=\"UTF-8\">");
//            out.println("<link href=\"URL_адрес_CSS_файла\" rel=\"stylesheet\" type=\"text/css\">");
            ...
            out.println("<caption><b>CheckSAX Clients</b></caption>");   
            out.println("<thead>");
            out.println("<tr>");
